...
description: 'This project aims to develop an reporting checklist in order to improve the reproducibility of data extraction for evidence synthesis researches (like systematic reviews), where “raw material” from original studies is transferred to reviews that serve as the basis for evidence synthesis. The reporting guideline under development will allow authors to write up the manuscript section related to the data extraction procedures.
